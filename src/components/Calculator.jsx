...
const Calculator = () => {
    ...
    return (
        <main className={`flex flex-col gap-4 items-center justify-center min-h-screen p-4 transition-all duration-500 ${theme === "dark" ? "bg-gray-900 text-white" : "bg-gray-100 text-gray-900"}`}>
            {warning &&
